...
\begin{figure}[b]
    ...
    \begin{tabular}{c}
        \begin{minipage}{0.5\hsize}
            \centering
            \includegraphics{image/line-and-line-segment.ai}
            \caption{$x_1$と$x_2$を通る直線は点線部分も続く。$x_1$と$x_2$を結んでいる部分が線分、矢印が方向を、$x_2$は基点を表す}
        \end{minipage}
        \begin{minipage}{0.5\hsize}
            \centering
            \includegraphics{image/affine-hull.ai}
